...
|--------|-------------------|--------|
| 09/02 | Apresentação da disciplina<br>Definição das equipes e da ideia do projeto de cada equipe (tema).<br>Obs: Todos os grupos deverão ter pelo menos uma proposta de tema, ao final da aula. | N/A |
| 16/02 | Carnaval – Recesso escolar, do corpo docente e administrativo | - |
| 23/02 | Sprint 1 / Semana 1 – Definição Inicial do Trabalho<br>Artefatos/resultados:<br>Definição inicial dos temas dos trabalhos<br>Lean Inception - Visão de Produto | N/A |
| 02/03 | Sprint 1 / Semana 2: Definição Inicial do Trabalho - Apresentação / Entrega 1<br>Artefatos/resultados:<br>Definição final dos temas dos trabalhos<br>Lean Inception - Visão de Produto | Sprint 1 - Entrega: 5 |
| 09/03 | Sprint 2 / Semana 1: Iniciação do Projeto e Arquitetura<br>Artefatos/resultados:<br>Documento de Arquitetura de Software - Seção 1 - Versão Inicial<br>Documento de Arquitetura de Software: Seção 2 - Versão Inicial<br>Documento de Arquitetura de Software: Seção 3 - Versão Inicial<br>Documento de Arquitetura de Software: Seção 4 - Versão Inicial<br>Github Classroom (Ambiente Criado) – Versão Final<br>Planejamento geral do projeto (Product backlog) - Versão Inicial<br>Planejamento da Sprint 2 (Sprint Backlog) - Versão Inicial<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 16/03 | Sprint 2 / Semana 2: Iniciação do Projeto e Arquitetura<br>Artefatos/resultados:<br>Documento de Arquitetura de Software - Seção 1 - versão atualizada<br>Documento de Arquitetura de Software: Seção 2 - versão atualizada<br>Documento de Arquitetura de Software: Seção 3 - versão atualizada<br>Documento de Arquitetura de Software: Seção 4 - versão atualizada<br>Planejamento da Sprint 2 atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 23/03 | Sprint 2 / Semana 3: Iniciação do Projeto e Macroarquitetura – Entrega 2<br>Artefatos/resultados:<br>Termo de Abertura de Projeto<br>Documento de Arquitetura de Software: Seção 1 - versão final<br>Documento de Arquitetura de Software: Seção 2 - versão final<br>Documento de Arquitetura de Software: Seção 3 - versão final<br>Documento de Arquitetura de Software: Seção 4 - versão final<br>Fechamento da sprint 2<br>Planejamento da Sprint 3<br>Relatório de Contribuição Semanal (Individual) | Sprint 2 - Entrega: 15 (Nota Individualizada) |
| 30/03 | Semana Santa – Recesso escolar, do corpo docente e administrativo | - |
| 06/04 | Sprint 3 - Semana 1: Prototipação<br>Artefatos/resultados:<br>Protótipo inicial de interfaces / wireframe - versão inicial<br>Código parcial do front-end e do back-end (com navegabilidade) - versão inicial<br>Ata de reunião de kickoff<br>Planejamento da Sprint 3 atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 13/04 | Sprint 3 - semana 2: Microarquitetura e prototipação – Entrega 3<br>Artefatos/resultados:<br>Protótipos de interfaces – versão corrigida<br>Ata de reunião de kickoff<br>Estrutura analítica do projeto (EAP) - versão final<br>Código parcial do front-end e do back-end (com navegabilidade) - versão corrigida<br>Avaliação Heuristica<br>Fechamento da Sprint 3<br>Planejamento da Sprint 4<br>Relatório de Contribuição Semanal (Individual) | Sprint 3 - Entrega: 10 (Nota Individualizada) |
| 20/04 | Sprint 4 - Semana 1: Entrega parcial 1<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades prioritárias - versão inicial<br>Release do software com as histórias priorizadas implementadas - versão inicial<br>Planejamento da Sprint 4 - Atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 27/04 | Sprint 4 - semana 2: Entrega parcial 2<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades prioritárias - versão corrigida<br>Release do software com as histórias priorizadas implementadas - versão corrigida<br>Planejamento da Sprint 4 - Atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 04/05 | Sprint 4 - semana 3: Entrega parcial 3 – Entrega 4<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades prioritárias - versão final<br>Release do software com as histórias priorizadas implementadas - versão final<br>Fechamento do Planejamento da Sprint 4<br>Atas de reunião semanais<br>Planejamento da Sprint 5<br>Relatório de Contribuição Semanal (Individual) | Sprint 4 - Entrega: 15 (Nota Individualizada) |
| 11/05 | Sprint 5 - semana 1: Entrega parcial 1<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades desejáveis - versão inicial<br>Implementação de testes (Funcionalidades Prioritárias) - versão inicial<br>Release do software com as histórias priorizadas implementadas<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 18/05 | Sprint 5 - semana 2: Entrega parcial 2<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades desejáveis - versão corrigida<br>Implementação de testes (Funcionalidades Prioritárias) - versão corrigida<br>Release do software com as histórias priorizadas implementadas<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 25/05 | Sprint 5 - semana 3: Entrega parcial 3<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades desejáveis - versão corrigida<br>Implementação de testes (Funcionalidades Prioritárias) - versão corrigida<br>Release do software com as histórias priorizadas implementadas<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 01/06 | Sprint 5 - semana 4: Entrega parcial 4 – Entrega 5<br>Artefatos/resultados:<br>Código do front-end e do back-end com funcionalidades desejáveis - versão final<br>Implementação de testes (Funcionalidades Prioritárias) - versão final<br>Release do software com as histórias priorizadas implementadas<br>Atas de reunião semanais<br>Fechamento da Sprint 5<br>Planejamento da Sprint 6<br>Relatório de Contribuição Semanal (Individual) | Sprint 5 - Entrega: 15 (Nota Individualizada) |
| 08/06 | Sprint 6 - semana 1: Entrega parcial 1 / Avaliação da Arquitetura<br>Artefatos/resultados:<br>Código completo do front-end e do back-end (Refinamento e/ou Implementação de Funcionalidades Opcionais)<br>Implementação de testes (Funcionalidades Desejáveis) - versão inicial<br>Release do software com todas as histórias de usuário implementadas<br>Avaliação da Arquitetura – versão inicial - método ATAM: Introd. ATAM<br>Planejamento da Sprint 6 atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 15/06 | Sprint 6 - semana 2: Entrega parcial 2 / Avaliação da Arquitetura<br>Artefatos/resultados:<br>Código completo do front-end e do back-end (Refinamento e/ou Implementação de Funcionalidades Opcionais)<br>Implementação de testes (Funcionalidades Desejáveis) - versão corrigida<br>Release do software com todas as histórias de usuário implementadas<br>Avaliação da Arquitetura – ATAM - versão inicial<br>Planejamento da Sprint 6 atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 22/06 | Sprint 6 - semana 3: Entrega final / Avaliação da Arquitetura / Apresentação<br>Artefatos/resultados:<br>Documento de Arquitetura de Software (versão final, completa e atualizada)<br>Código completo do front-end e do back-end (Refinamento e/ou Implementação de Funcionalidades Opcionais)<br>Implementação de testes (Funcionalidades Desejáveis) - versão atualizada<br>Release do software com todas as histórias priorizadas implementadas<br>Avaliação da Arquitetura – versão atualizada<br>Planejamento da Sprint 6 atualizado<br>Relatório de Contribuição Semanal (Individual) | N/A |
| 29/06 | Sprint 6 - semana 4: Entrega final / Avaliação da Arquitetura / Apresentação<br>Artefatos/resultados:<br>Documento de Arquitetura de Software (versão final, completa e atualizada)<br>Código completo do front-end e do back-end (Refinamento e/ou Implementação de Funcionalidades Opcionais)<br>Implementação de testes (Funcionalidades Desejáveis) - versão final<br>Release do software com todas as histórias priorizadas implementadas<br>Avaliação da Arquitetura – versão final<br>Relatório de encerramento do projeto<br>Vídeo de apresentação do projeto (pitch)<br>Fechamento da Sprint 6<br>Atas de reunião semanais<br>Relatório de Contribuição Semanal (Individual) | Sprint 6 - Entrega: 40 (Nota Individualizada) |
